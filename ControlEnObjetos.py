...
#                time.sleep(5)
    ...
    def MediciónManual(self):
        ...
        def SetearNumeroDeConstantesDeTiempo():
            comando = textoNumeroDeConstantesDeTiempo.get()
        ...
        def IrALaPosicionMonocromador():
            comando = textoPosicionMonocromador.get()
